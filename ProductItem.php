							...
							<div class="row product-page">
                                                            <div ng-app="myApp.controllers" ng-controller="ImagesCtrl">
                                                                ...
                                                                <div class="span4">
                                                                    <div>
                                                                        <div class="big_image">
                                                                            <a href="images/shop_images/page/img1.jpg" rel="prettyPhoto"><img src="GalleryImages/{{image.imageName}}" alt="" /></a>
                                                                        </div>
                                                                ...
                                                                <div class="span5">
                                                                    <div class="main-data">
                                                                        <p class="name">{{image.imageDescription}}</p>
                                                                        ...
                                                                        <p class="regular_price">Regular Price: <span>{{image.price}}</span></p>
                                                                        <p class="price">
