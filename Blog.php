...
<head>
	<title>BLOG | WISCONSIN PHOTOGRAPHY</title>
					...
					<div class="row">
						<div class="span9">
							 ...
							 <div class="itemListView clearfix eBlog">
								...
								<div class="itemList">
								<div ng-app="" ng-controller="blogsController">
                                                                    <div ng-repeat="x in blogs">
									<div class="itemContainer">
                                                                            
										<div class="itemHeader">
											<h3 class="itemTitle">
												<a href="pages-blogitem.html">{{x.blogHeading}}</a>
											</h3>
											<div class="post_details">
												<span class="catItemDateCreated"><span class="icon-calendar"></span> {{x.blogDate}}</span>
												<span class="catItemAuthor">by <a rel="author" href="#">{{x.author}}</a></span>
											</div><!-- end post details -->
										</div><!-- end itemHeader -->
									
										<div class="itemBody">
											<div class="itemIntroText">
                                                                                            <p><a href="" class="hoverBorder pull-left" style="margin-right: 20px; width:300px;"><img src="GalleryImages/{{x.image}}" border="0" alt=""  /></a>
                                                                                            <p>{{x.blogIntroText}}</p>
											</div><!-- end Item Intro Text -->
											<div class="clear"></div>
											<div class="itemReadMore">
												<a class="readMore" href="pages-blogitem.html">Read more...</a>
											</div><!-- end read more -->
											<div class="clear"></div>
										</div><!-- end Item BODY -->
...
function blogsController($scope,$http) {
                ...
                $http.get("http://localhost/SRPhotography/api/blogapi.php")
    .success(function(response) {$scope.blogs = response;});
