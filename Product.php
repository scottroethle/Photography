				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
                                                    ...
                                                    } elseif (!empty($_GET["StatePark"])){
                                                        echo htmlspecialchars($_GET["StatePark"]);
                                                    }
                                                    echo "</h2>";
                                                    ?>
							<h4>Explore this amazing city</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
				...
				<div id="mainbody">
						...
						<div class="span12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div ng-app="myApp.controllers" ng-controller="ImagesCtrl">
`       
                                                ...
                                                <div ng-repeat="image in images">
                                                    <div class="span3">
                                                        <div class="product-list-item">
                                                            ...
                                                            <div class="image">
                                                                 <a href="ProductItem.php?ImageID={{image.imageID}}"><img src="GalleryImages/{{image.imageName}}" alt="" ></a>                                                                                              
                                                            </div>
                                                            <div class="details fixclear">
                                                                    <h3>{{image.imageDescription}}</h3>
                                                                <p class="desc">{{image.imageName}}</p>
                                                                <div class="actions">
                                                                    <a href="#">ADD TO CART</a>
                                                                    <a href="pages-productitem.html">MORE INFO</a>
                                                                </div>
                                                                <div class="price">
                                                                    <span>${{image.price}} - Canvas </span>
